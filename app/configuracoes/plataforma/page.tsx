export default function Plataforma() {
  return (
    <div className="p-6 md:p-7">
      <h1 className="text-sm font-medium text-[var(--content-text)] mb-3.5">Plataforma</h1>
      ...
      <div className="flex justify-end gap-2.5 pt-3 border-t border-[var(--content-border)]">
        <button className="px-4 py-1.5 rounded-full text-xs font-medium text-[var(--md-sys-color-primary)] border border-[var(--content-border)] hover:bg-[rgba(208,188,255,0.08)] transition-colors">
          Cancelar
        </button>
