  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        ...
        <button className="flex items-center gap-2 px-6 py-2 bg-[var(--md-sys-color-secondary)] text-white rounded-lg hover:bg-[var(--md-sys-color-primary-container)] transition-colors label-lg">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <h3 className="flex items-center gap-2 headline-md text-[var(--content-text)] mb-6 pb-4 border-b border-[var(--content-border)]">
            <i className="ti ti-login text-[var(--md-sys-color-secondary)]" />
            Autenticação & Acesso
          </h3>
          <div className="space-y-6">
            {/* Autenticação */}
            <div>
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Métodos de Autenticação</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={key} className="flex items-center justify-between">
                    <span className="body-md text-\[var(--content-text-secondary)\]">{label}</span>
                    <Toggle
                      id={key}
            ...
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Fingerprint</h4>
              <div className="flex items-center justify-between">
                <span className="body-md text-\[var(--content-text-secondary)\]">Habilitar fingerprint</span>
                <Toggle
                  id="fingerprint"
            ...
            {/* Bloqueios */}
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Restrições de Acesso</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
            ...
            {/* Política de cookies */}
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Política de Cookies</h4>
              <div className="flex items-center justify-between">
                <span className="body-md text-\[var(--content-text-secondary)\]">Habilitar modal de política de cookies</span>
                <Toggle
                  id="cookiesModal"
            ...
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Autenticação Multifatorial</h4>
              <div className="flex items-center justify-between">
                <span className="body-md text-[var(--md-sys-color-secondary)] font-semibold">Habilitar multifatorial obrigatório a cada dia</span>
                <Toggle
                  id="mfaDaily"
            ...
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Controle de Acesso</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block label-md text-[var(--content-text-secondary)] mb-2">
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--content-bg)] border border-[var(--content-border)] rounded-lg px-3 py-2 text-[var(--content-text)] focus:border-[var(--md-sys-color-secondary)] focus:ring-1 focus:ring-[var(--md-sys-color-secondary)] outline-none"
                  />
                </div>
                <div>
                  <label className="block label-md text-[var(--content-text-secondary)] mb-2">
        ...
        <Card className="p-6">
          <h3 className="flex items-center gap-2 headline-md text-[var(--content-text)] mb-6 pb-4 border-b border-[var(--content-border)]">
            <i className="ti ti-user-plus text-[var(--md-sys-color-secondary)]" />
            Regras de Cadastro
          </h3>
          <div className="space-y-6">
            {/* Dados */}
            <div>
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Dados</h4>
            ...
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Requisitos de Senhas</h4>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block label-caps text-\[var(--content-text-secondary)\] mb-2">
                  ...
                  {[
                    ...
                    <div key={key}>
                      ...
                      <select
                        ...
                        className={`w-full bg-[var(--content-bg)] border ${config[key as keyof typeof config] ? 'border-[var(--md-sys-color-secondary)]' : 'border-[var(--content-border)]'} rounded-lg px-3 py-2 text-[var(--content-text)] focus:border-[var(--md-sys-color-secondary)] outline-none`}
                      >
                        <option>NÃO</option>
                        <option>SIM</option>
                      </select>
            ...
            {/* Validação Captcha */}
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Validação Captcha</h4>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="body-md text-\[var(--content-text-secondary)\]">Habilitado</span>
                  <Toggle
                    id="captchaEnabled"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[var(--content-bg)] border border-[var(--content-border)] rounded-lg px-3 py-2 text-[var(--content-text)] focus:border-[var(--md-sys-color-secondary)] outline-none"
                  >
        ...
        <Card className="p-6 xl:col-span-2">
          <h3 className="flex items-center gap-2 headline-md text-[var(--content-text)] mb-6 pb-4 border-b border-[var(--content-border)]">
            <i className="ti ti-checkup-list text-[var(--md-sys-color-secondary)]" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-5 border-2 border-[var(--content-border)] rounded-xl bg-[var(--content-surface)] space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[var(--content-border)]">
                <h4 className="headline-sm text-[var(--content-text)] flex items-center gap-2">
                  <i className="ti ti-user-check text-[var(--md-sys-color-secondary)]" />
                  Verificação de Antecedentes
                </h4>
                <span className="bg-[#1b3322] text-[#2ecc71] px-3 py-1.5 rounded-lg label-caps">
                  ATIVO
                </span>
              </div>
              <div>
                ...
                <select className="w-full bg-[var(--content-bg)] border border-[var(--content-border)] rounded-lg px-3 py-2.5 text-[var(--content-text)] focus:border-[var(--md-sys-color-secondary)] focus:ring-2 focus:ring-[var(--md-sys-color-secondary)]/20 outline-none">
            ...
            <div className="p-5 border-2 border-[var(--content-border)] rounded-xl bg-[var(--content-surface)] space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[var(--content-border)]">
                <h4 className="headline-sm text-[var(--content-text)] flex items-center gap-2">
                  <i className="ti ti-shield-check text-[var(--md-sys-color-secondary)]" />
              ...
              <div className="pt-4 border-t border-[var(--content-border)] grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={key} className="flex flex-col items-center gap-3 p-3 bg-[var(--content-hover)] rounded-lg border border-[var(--content-border)]">
                    <span className="label-caps text-\[var(--content-text)\] text-center">
                      {label}
                    </span>
                    <input
                      type="checkbox"
                      checked={config[key as keyof typeof config] as boolean}
                      onChange={() => setConfig({ ...config, [key]: !config[key as keyof typeof config] })}
                      className="w-5 h-5 text-[var(--md-sys-color-secondary)] bg-[var(--content-bg)] border-[var(--content-border)] rounded focus:ring-[var(--md-sys-color-secondary)] focus:ring-2 cursor-pointer"
                    />
                  </div>
                ))}
              </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Política de segurança de conteúdo</h4>
              <div>
                <label className="block label-caps text-\[var(--content-text-secondary)\] mb-2">
                ...
                <textarea
                  rows={6}
                  className="w-full bg-[#121212] border border-[var(--content-border)] rounded-lg px-3 py-2 text-[var(--content-text-secondary)] font-mono body-sm focus:border-[var(--md-sys-color-secondary)] outline-none resize-none"
            ...
            {/* Google reCaptcha */}
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Google reCaptcha</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block label-caps text-\[var(--content-text-secondary)\] mb-2">
                    Secret key
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--content-bg)] border border-[var(--content-border)] rounded-lg px-3 py-2 text-[var(--content-text)] font-mono body-sm focus:border-[var(--md-sys-color-secondary)] outline-none"
                    readOnly
                  />
                </div>
              </div>
            ...
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Cloudflare Turnstile</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block label-caps text-\[var(--content-text-secondary)\] mb-2">
                    Secret key
            ...
            {/* Sport Radar */}
            <div className="border-t border-[var(--content-border)] pt-4">
              <h4 className="label-caps text-\[var(--content-text-secondary)\] mb-3">Sport Radar</h4>
              <div>
                <label className="block label-caps text-\[var(--content-text-secondary)\] mb-2">
                  Client ID
                </label>
                <input
                  ...
                  className="w-full md:w-1/2 bg-[var(--content-bg)] border border-[var(--content-border)] rounded-lg px-3 py-2 text-[var(--content-text)] font-mono body-md focus:border-[var(--md-sys-color-secondary)] outline-none"
                />
              </div>
            </div>
          </div>
