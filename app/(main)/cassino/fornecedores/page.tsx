        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-[var(--content-border)]">
              ...
              <th className="text-[10px] text-[var(--content-text-secondary)] uppercase tracking-[0.8px] font-semibold text-left py-2 px-3">Jogos</th>
              ...
              <th className="text-[10px] text-[var(--content-text-secondary)] uppercase tracking-[0.8px] font-semibold text-left py-2 px-3">Participação</th>
            </tr>
          </thead>
          <tbody>
            {providers.map((p, i) => (
